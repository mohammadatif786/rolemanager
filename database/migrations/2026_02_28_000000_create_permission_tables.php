...
return new class extends Migration
{
    ...
    public function down()
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not found and defaults could not be merged. Please publish the package configuration before before rolling back the migration.');
        }
